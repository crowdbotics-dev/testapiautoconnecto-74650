...
## Project Structure
    ...
    ├── testapiautoconnecto_74650  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_74650`
...
2. Clone this repo and `cd testapiautoconnecto_74650`
